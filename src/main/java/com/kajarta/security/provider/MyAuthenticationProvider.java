package com.kajarta.security.provider;

import com.kajarta.security.SecurityUser;
import com.kajarta.security.exception.UserLoginException;
import com.kajarta.security.service.impl.EmployeeDetailsServiceImpl;
...
public class MyAuthenticationProvider implements AuthenticationProvider {
    ...
    @Autowired
    public void setUserDetailsService(EmployeeDetailsServiceImpl employeeDetailsService) {
...
//        }
        ...
        usernamePasswordToken.setEmployeeId(userDetails.getEmployeeId());
