package com.kajarta.security.service.impl;

import com.kajarta.demo.model.Customer;
import com.kajarta.demo.model.Employee;
import com.kajarta.security.SecurityUser;
import com.kajarta.security.service.EmployeeDetailsService;
...
//        boolean googleEnable = Optional.ofNullable(admin.getGoogleEnable()).orElse(false);
        ...
        return new SecurityUser(Long.parseLong(employee.getId().toString()),
                employee.getAccount(),
