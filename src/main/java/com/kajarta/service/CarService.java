...
public class CarService {
    ...
    public Car create(String json) {
        try {
            ...
            Short negotiable = obj.isNull("negotiable") ? null : (short) obj.getInt("negotiable");
            ...
            Instant launchDate = obj.isNull("launchDate") ? null : Instant.parse(obj.getString("launchDate"));
